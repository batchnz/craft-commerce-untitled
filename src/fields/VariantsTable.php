 ...
 * @since     1.0.0
 */
class VariantsTable extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('craft-commerce-untitled', 'VariantsTable');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-commerce-untitled/_components/fields/VariantsTable_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(VariantsTableFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').CraftCommerceUntitledVariantsTable(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'craft-commerce-untitled/_components/fields/VariantsTable_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
